...
DeclareTask(AccOnOff);
DeclareTask(ReceiveCANM3);
DeclareTask(ReceiveCANM4);
DeclareTask(ReceiveCANM5);
DeclareTask(ReceiveSetSpeed);
DeclareTask(SendCANM1);
DeclareTask(SendCANM2);
DeclareResource(res1);
DeclareAlarm(periodicAlarm1);
DeclareAlarm(periodicAlarm2);
DeclareAlarm(periodicAlarm3);
DeclareAlarm(periodicAlarm4);
DeclareAlarm(periodicAlarm5);
DeclareAlarm(periodicAlarm6);
DeclareAlarm(periodicAlarm7);
