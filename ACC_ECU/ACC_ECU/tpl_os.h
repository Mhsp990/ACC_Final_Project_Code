 ...
 *
 * Generated from application ECM
...
DeclareTask(Calculate_ACC_Acceleration);
DeclareTask(Can_Receive);
DeclareTask(Logic_block);
DeclareResource(res1);
DeclareAlarm(alarmeCalculate_ACC_Acceleration);
DeclareAlarm(alarmeCan_Receive);
DeclareAlarm(alarmeLogic_block);
