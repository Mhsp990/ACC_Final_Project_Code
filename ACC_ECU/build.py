...
# -*- coding: UTF-8 -*-
#----------------------------------------------------------------------
#--- Python Build file for application ECM
...
#--- OIL file
oilSourceList.append("ACC_ECU.oil")
...
cSourceList.append(projfile.ProjectFile("ACC_ECU.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("ACC_ECU/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("ACC_ECU/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("ACC_ECU/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("ACC_ECU/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary image.hex from image")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("image")
  postCommand.mCommand.append("image.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing image on avr/arduino/nano\033[0m")
