 ...
 * Automatically generated by goil on Sun Sep 10 15:34:57 2023
...
/* Task SenderRainSensor identifier */
#define SenderRainSensor_id 1
CONST(TaskType, AUTOMATIC) SenderRainSensor = SenderRainSensor_id;
...
/*-----------------------------------------------------------------------------
 * Task SenderRainSensor descriptor
 */
#define APP_Task_SenderRainSensor_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task SenderRainSensor function prototype
 */

FUNC(void, OS_APPL_CODE) SenderRainSensor_function(void);
#define APP_Task_SenderRainSensor_STOP_SEC_CODE
...
/*
 * Task SenderRainSensor stack
 *
 */
#define APP_Task_SenderRainSensor_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word SenderRainSensor_stack_zone[256/sizeof(tpl_stack_word)];
#define APP_Task_SenderRainSensor_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define SenderRainSensor_STACK { SenderRainSensor_stack_zone, 256 }

/*
 * Task SenderRainSensor context
 */
avr_context SenderRainSensor_int_context;
#define SenderRainSensor_CONTEXT &SenderRainSensor_int_context
...
/*
 * Static descriptor of task SenderRainSensor
 */
CONST(tpl_proc_static, OS_CONST) SenderRainSensor_task_stat_desc = {
  /* context                  */  SenderRainSensor_CONTEXT,
  /* stack                    */  SenderRainSensor_STACK,
  /* entry point (function)   */  SenderRainSensor_function,
  /* internal ressource       */  NULL,
  /* task id                  */  SenderRainSensor_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
#endif
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task SenderRainSensor
 */
VAR(tpl_proc, OS_VAR) SenderRainSensor_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
...
tpl_stat_proc_table[TASK_COUNT+ISR_COUNT+1] = {
  ...
  &SenderRainSensor_task_stat_desc,
 ...
 *
 * This alarm does the activation of task SenderRainSensor
 */
