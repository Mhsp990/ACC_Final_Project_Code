...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file SENSORS_ECU.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/nano --templates=../../../..//goil/templates/ SENSORS_ECU.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("SENSORS_ECU/tpl_app_config.c")

sourceList.append("SENSORS_ECU/tpl_dispatch_table.c")
sourceList.append("SENSORS_ECU/tpl_invoque.S")
sourceList.append("SENSORS_ECU/tpl_interrupts.c")
