...
#--- OIL file
oilSourceList.append("SENSORS_ECU.oil")
...
cSourceList.append(projfile.ProjectFile("SENSORS_ECU.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("SENSORS_ECU/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("SENSORS_ECU/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("SENSORS_ECU/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("SENSORS_ECU/tpl_interrupts.c"))
