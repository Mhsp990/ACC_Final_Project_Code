...
int main ()
{
  //Creation of file to plot and analize the beahavior of the ACC system
  char *filename = "Simulation_Code.csv";  
  ...
  fprintf(fp,"Ego Acceleration:, ");
  fprintf(fp,"SafeDistance:, ");
  fprintf(fp,"RelativeDistance:, ");
  fprintf(fp,"EgoVelocity:, ");
  fprintf(fp,"LeadVelocity:, ");
  fprintf(fp,"Time: \n");
