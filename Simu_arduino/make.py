...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file Simu_arduino.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/nano --templates=../../../goil/templates/ Simu_arduino.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("Simu_arduino/tpl_app_config.c")

sourceList.append("Simu_arduino/tpl_dispatch_table.c")
sourceList.append("Simu_arduino/tpl_invoque.S")
sourceList.append("Simu_arduino/tpl_interrupts.c")
