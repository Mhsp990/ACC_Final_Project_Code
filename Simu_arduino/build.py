...
#--- automatically generated by goil on Tue Sep 12 18:56:13 2023
...
#--- OIL file
oilSourceList.append("Simu_arduino.oil")
...
cSourceList.append(projfile.ProjectFile("Simu_arduino.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("Simu_arduino/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("Simu_arduino/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("Simu_arduino/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("Simu_arduino/tpl_interrupts.c"))
